...
type GuestServiceV1alpha1 struct {
	sess *session.Session
}

func NewGuestServiceV1alpha1(sess *session.Session) *GuestServiceV1alpha1 {
	return &GuestServiceV1alpha1{sess: sess}
}

func (gs *GuestServiceV1alpha1) CreateGuest(clusterName, hostName string, machineSpec *ibmcloudv1.IBMCloudMachineProviderSpec, userScript string) {
...
func (gs *GuestServiceV1alpha1) waitGuestReady(ID int) error {
	// Wait for transactions to finish
...
func (gs *GuestServiceV1alpha1) DeleteGuest(ID int) error {
	s := services.GetVirtualGuestService(gs.sess).Id(ID)
...
func (gs *GuestServiceV1alpha1) GetGuest(name, domain string) (*datatypes.Virtual_Guest, error) {
