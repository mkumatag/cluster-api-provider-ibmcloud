...
// Package v2alpha1 contains API Schema definitions for the ibmcloud v2alpha1 API group
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=sigs.k8s.io/cluster-api-provider-ibmcloud/pkg/apis/ibmcloud
// +k8s:defaulter-gen=TypeMeta
// +groupName=ibmcloud.cluster.k8s.io
package v2alpha1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "ibmcloud.cluster.k8s.io", Version: "v2alpha1"}
...
func EncodeMachineStatus(status *IBMCloudMachineProviderStatus) (*runtime.RawExtension, error) {
	if status == nil {
		return &runtime.RawExtension{}, nil
	}
